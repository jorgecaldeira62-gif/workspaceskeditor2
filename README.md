# @workspace/sk-editor2 — App Desktop
...
- **Windows**: `-workspace-sk-editor2-Setup-1.0.0.exe`
- **Mac**: `-workspace-sk-editor2-1.0.0.dmg`
- **Linux**: `-workspace-sk-editor2-1.0.0.AppImage`
